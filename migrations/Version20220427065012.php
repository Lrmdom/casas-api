 ...
 */
final class Version20220427065012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reserva ADD CONSTRAINT FK_188D2E3B31BFD36A FOREIGN KEY (cod_casa) REFERENCES casa (cod_casa)');
