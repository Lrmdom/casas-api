 ...
 */
final class Version20220430174452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE alert CHANGE for_rent for_rent TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE for_sale for_sale TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE for_arrenda for_arrenda TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE valor_arrenda valor_arrenda INT DEFAULT NULL, CHANGE valor_venda valor_venda INT DEFAULT NULL, CHANGE valor_rent valor_rent INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE alert CHANGE for_rent for_rent TINYINT(1) NOT NULL, CHANGE for_sale for_sale TINYINT(1) NOT NULL, CHANGE for_arrenda for_arrenda TINYINT(1) NOT NULL, CHANGE valor_arrenda valor_arrenda INT DEFAULT NULL, CHANGE valor_venda valor_venda INT DEFAULT NULL, CHANGE valor_rent valor_rent INT DEFAULT NULL');
        $this->addSql('ALTER TABLE casa CHANGE propid propid INT DEFAULT NULL, CHANGE destino destino INT DEFAULT NULL, CHANGE tipo tipo INT DEFAULT NULL, CHANGE quartos quartos INT DEFAULT NULL, CHANGE camascasal camascasal INT DEFAULT NULL, CHANGE camassingle camassingle INT DEFAULT NULL, CHANGE casasbanho casasbanho INT DEFAULT NULL, CHANGE valor_venda valor_venda INT DEFAULT NULL');
        $this->addSql('ALTER TABLE casaattributes CHANGE cod_casa cod_casa INT DEFAULT NULL');
        $this->addSql('ALTER TABLE casacancelissue CHANGE propid propid INT DEFAULT NULL');
        $this->addSql('ALTER TABLE casageodata CHANGE cod_casa cod_casa INT DEFAULT NULL');
